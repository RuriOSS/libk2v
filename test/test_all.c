...
int main() {
    ...
    k2v_show_warning = true; // Show warnings for debugging
    // ---------------------------------------------------------
    ...
    for (int i = 0; i < len; i++) free(s_arr[i]);
    ...
    bool stop_at_warn_original = k2v_stop_at_warning;
    bool show_warning_original = k2v_show_warning;
    k2v_stop_at_warning = false;
    k2v_show_warning = false; // Suppress noisy warnings for bad values during test
    ...
    k2v_stop_at_warning = stop_at_warn_original;
    k2v_show_warning = show_warning_original;
